...
use pictorus_px4::{
    ...
    uorb_binding::{UorbBinding, UorbInputBlock, UorbOutputBlock},
};
use pictorus_traits::{
...
pub struct Actuatoroutpute8ed1Component {
    ...
    actuator_motors_output_param: <UorbOutputBlock<ActuatorMotors> as OutputBlock>::Parameters,
    actuator_motors_output_block: UorbOutputBlock<ActuatorMotors>,
}
...
impl Actuatoroutpute8ed1Component {
    pub fn new(_context: &Context) -> Self {
        ...
        let actuator_motors_output_param =
            <UorbOutputBlock<ActuatorMotors> as OutputBlock>::Parameters::new();
        let actuator_motors_output_block = UorbOutputBlock::default();
...
pub struct Manualinpute8ec8Component {
    ...
    manual_input_param: <UorbInputBlock<ManualControlInput> as InputBlock>::Parameters,
    manual_input_block: UorbInputBlock<ManualControlInput>,
...
impl Manualinpute8ec8Component {
    pub fn new(_context: &Context) -> Self {
        let manual_input_param =
            <UorbInputBlock<ManualControlInput> as InputBlock>::Parameters::new();
        let manual_input_block = UorbInputBlock::default();
...
pub struct Vehicleodometerye8edaComponent {
    last_time_s: f64,
    vehicle_odometry_param: <UorbInputBlock<VehicleOdometry> as InputBlock>::Parameters,
    vehicle_odometry_block: UorbInputBlock<VehicleOdometry>,
...
impl Vehicleodometerye8edaComponent {
    pub fn new(_context: &Context) -> Self {
        let vehicle_odometry_param =
            <UorbInputBlock<VehicleOdometry> as InputBlock>::Parameters::new();
        let vehicle_odometry_block = UorbInputBlock::default();
...
impl IoManager {
    ...
    pub fn new() -> Result<Self, PictorusError> {
        UorbBinding::get_mut().subscribe_to_message(VehicleOdometry);
        UorbBinding::get_mut().subscribe_to_message(ManualControlInput);
        UorbBinding::get_mut().advertise_message(ActuatorMotors);
        UorbBinding::get_mut().advertise_message(ActuatorArmed);
        Ok(Self {})
    }
...
impl AppInterface {
    ...
    pub fn update(&mut self) {
        ...
        if app_time_us - self.last_armed_time > 500_000 {
            UorbOutputBlock::<ActuatorArmed>::default().output(
                &<UorbOutputBlock<ActuatorArmed> as OutputBlock>::Parameters::new(),
