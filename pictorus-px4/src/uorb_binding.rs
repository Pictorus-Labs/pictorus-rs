...
///
/// ```rust
/// use pictorus_px4::uorb_binding::UorbBinding;
...
impl UorbBinding {
    ...
    pub fn get_mut() -> RwLockWriteGuard<'static, UorbBinding> {
        FFI_PROTOCOL.write()
    }
...
///
/// ```rust
/// use pictorus_px4::uorb_binding::UorbOutputBlock;
/// use pictorus_px4::message_impls::VehicleAttitudeSetpoint;
///
/// // Create an output block for vehicle attitude setpoints
/// let mut output_block = UorbOutputBlock::<VehicleAttitudeSetpoint>::default();
///
...
pub struct UorbBlockParameters;
impl UorbBlockParameters {
    pub fn new() -> Self {
        Self {}
    }
}
    ...
    T::Message: FromPassType,
{
    ...
    type Parameters = UorbBlockParameters;
...
///
/// ```rust
/// use pictorus_px4::uorb_binding::UorbInputBlock;
/// use pictorus_px4::message_impls::SensorAccel;
///
/// // Create an input block for accelerometer data
/// let mut input_block = UorbInputBlock::<SensorAccel>::default();
///
...
mod tests {
    ...
    fn test_concurrent_access() {
        ...
        {
            let _read_guard = UorbBinding::get();
            // Multiple read guards should be possible
            let _read_guard2 = UorbBinding::get();
        }
        ...
        let read_guard = UorbBinding::get();
